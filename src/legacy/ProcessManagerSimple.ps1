...
function Show-Menu {
    ...
    Write-Host "â”‚                         OPCIONES                           â”‚" -ForegroundColor White
    Write-Host "â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤" -ForegroundColor White
    Write-Host "â”‚  1. Ver procesos por categoria                             â”‚" -ForegroundColor Green
    Write-Host "â”‚  2. Cerrar TODOS los procesos recomendados                 â”‚" -ForegroundColor Red
    Write-Host "â”‚  3. Cerrar procesos por categoria especifica               â”‚" -ForegroundColor Yellow
    Write-Host "â”‚  4. Cerrar proceso individual                              â”‚" -ForegroundColor Cyan
    Write-Host "â”‚  5. Salir                                                  â”‚" -ForegroundColor Gray
...
function Close-Processes {
    ...
    foreach ($proc in $ProcessesToClose) {
        try {
            ...
            $process.Kill()
            Write-Host "âœ“ Cerrado: $($proc.Name) (PID: $($proc.PID))" -ForegroundColor Green
    $successCount++
    Start-Sleep -Milliseconds 200
} catch {
    Write-Host "âœ— Error: $($proc.Name) (PID: $($proc.PID)) - $($_.Exception.Message)" -ForegroundColor Red
    $errorCount++
}
}
